...
public class Hero extends Actor {
    ...
    Hero(int positionCoordinates, int health, int mana, int armor, status actorStatus){
    ...
    public List<Move> calculateLegalMoves(final Board board){
        ...
        for(final int currentCandidate : CANDIDATE_MOVE_COORDINATES){
            final int candidateDestinationCoordinate = this.positionCoordinates + currentCandidate;
            ...
            if(isValidCellCoordinate(candidateDestinationCoordinate)){
                ...
                if(!candidateDestinationCell.isCellOccupied()){
                    ...
                    if(this.actorStatus != status.NOT_ALIVE){
                        legalMoves.add(new Move());
                    } 
                }                
            }            
